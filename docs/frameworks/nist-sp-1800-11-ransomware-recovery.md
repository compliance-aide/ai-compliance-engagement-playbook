# NIST SP 1800-11 ransomware recovery engagement guide

> Original operational guidance, not NIST practice-guide text, a recovery command, a legal interpretation, an insurance decision, or a compliance claim. Confirm current material through [NIST SP 1800-11](https://csrc.nist.gov/pubs/sp/1800/11/final) and applicable legal, insurance, customer, and authority direction.

## Engagement focus

Maintain recovery evidence for critical data, applications, configurations, business services, and dependencies that could be altered or destroyed by ransomware or another destructive event. Connect recovery objectives to known-good restore points, integrity checks, recovery sequencing, access records, investigation handoffs, service-restoration acceptance, communications, and lessons learned. Treat the practice guide as a way to organize a tested recovery capability rather than as a substitute for incident command, business decisions, or authority-specific notification and payment requirements.
