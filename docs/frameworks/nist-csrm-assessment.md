# NIST C-SCRM assessment engagement guide

> Original operational guidance, not a copied NIST questionnaire or assurance conclusion. See [NIST SP 800-161](https://csrc.nist.gov/pubs/sp/800/161/r1/upd1/final) and [SP 1326](https://csrc.nist.gov/pubs/sp/1326/final).

## Engagement focus

Maintain assessment universe, tiering, supplier/product criticality, due diligence, corroboration, confidence, residual-risk, vulnerability, concentration, resilience, and closure evidence.
...
**Guide-specific planning input.** Maintain assessment universe, tiering, supplier/product criticality, due diligence, corroboration, confidence, residual-risk, vulnerability, concentration, resilience, and closure evidence.
...
### 2. Operating evidence for NIST C-SCRM assessment

- **Request and owner:** Time-bounded impact analysis, plan/version, exercise, communications, recovery, supplier, and corrective-action records, selected because this guide focuses on maintain assessment universe, tiering, supplier/product criticality, due diligence, corroboration, confidence, residual-risk, vulnerability, concentration, resilience, and closure evidence., from resilience, service, incident, and supplier owners.
