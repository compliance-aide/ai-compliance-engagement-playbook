# NIST SP 800-66 Revision 2 — HIPAA security engagement guide

> Original operational guidance, not NIST content, HIPAA legal advice, or a compliance determination. Confirm current status at the [NIST publication record](https://csrc.nist.gov/pubs/sp/800/66/r2/final).

## Engagement focus

Maintain ePHI scope, risk decisions, workforce and system evidence, safeguards operations, incident records, business-associate dependencies, remediation, and the evidence needed for a HIPAA security review.
...
**Source and rights snapshot.** Use the guide's cited publisher source (https://csrc.nist.gov/pubs/sp/800/66/r2/final) and check its current edition or status before use. This plan uses original operational language and does not reproduce protected requirements, assessment questions, mappings, or branded templates. A named human engagement owner confirms applicability and source rights.

**Guide-specific planning input.** Maintain ePHI scope, risk decisions, workforce and system evidence, safeguards operations, incident records, business-associate dependencies, remediation, and the evidence needed for a HIPAA security review.
...
### 2. Operating evidence for NIST SP 800-66 Revision 2 — HIPAA security

- **Request and owner:** Time-bounded impact analysis, plan/version, exercise, communications, recovery, supplier, and corrective-action records, selected because this guide focuses on maintain ephi scope, risk decisions, workforce and system evidence, safeguards operations, incident records, business-associate dependencies, remediation, and the evidence needed for a hipaa security review., from resilience, service, incident, and supplier owners.
