...
### 2. Operating evidence for ISO 37301:2021

- **Request and owner:** Time-bounded scope/inventory, policy/procedure, operating, technical, change, exception, and review records, selected because this guide focuses on maintain an obligations register, accountability map, change monitoring, evidence, exception, and program-effectiveness records., from business, security, service, and supplier owners.
