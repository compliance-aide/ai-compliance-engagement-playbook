# NIST SP 800-82 Revision 3 — engagement guide

> Original operational guidance, not operational-technology safety approval.
> Consult the [NIST OT security publication](https://csrc.nist.gov/pubs/sp/800/82/r3/final)
> with site operations and safety leadership.

## Engagement focus

Start with safety, physical-process, and operating constraints. Maintain an
OT-aware asset and architecture record; prioritize risk by physical consequence;
evaluate safeguards only through safe, authorized methods; review maintenance,
remote support, recovery, and vendor access; and exercise non-disruptive
scenarios.
...
**Source and rights snapshot.** Use the guide's cited publisher source (https://csrc.nist.gov/pubs/sp/800/82/r3/final) and check its current edition or status before use. This plan uses original operational language and does not reproduce protected requirements, assessment questions, mappings, or branded templates. A named human engagement owner confirms applicability and source rights.

**Guide-specific planning input.** Start with safety, physical-process, and operating constraints. Maintain an OT-aware asset and architecture record; prioritize risk by physical consequence; evaluate safeguards only through safe, authorized methods; review maintenance, remote support, recovery, and vendor access; and exercise non-disruptive scenarios.
...
### 2. Operating evidence for NIST SP 800-82 Revision 3

- **Request and owner:** Time-bounded design/operating records, asset/configuration, maintenance, test/exercise, supplier, and corrective-action records, selected because this guide focuses on start with safety, physical-process, and operating constraints. maintain an ot-aware asset and architecture record; prioritize risk by physical consequence; evaluate safeguards only through safe, authorized methods; review maintenance, remote support, recovery, and vendor access; and exercise non-disruptive scenarios., from engineering, safety, operations, and supplier owners.
