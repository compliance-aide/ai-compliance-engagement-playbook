# NIST SP 800-53B low-impact baseline engagement guide
...
Use the low-impact baseline only after the organization has a documented, accountable system-impact determination and authority context. Maintain a controlled scope statement for the system, data, people, services, inherited capabilities, common controls, suppliers, boundaries, and material changes. Record the baseline selection source, tailoring rationale, overlays, deviations, risk decisions, and evidence ownership. Treat baseline selection as a starting point for a system-specific program; do not infer authorization or adequacy merely from a low-impact label.
