# UK employment data protection — engagement guide

> Original operational guidance, not ICO guidance or employment-law advice. Check the [ICO employment guidance hub](https://ico.org.uk/for-organisations/uk-gdpr-guidance-and-resources/employment/).

## Engagement focus

Maintain lifecycle processing, guidance-watch, hiring, retention, health, monitoring, biometric, home-working, sharing, request, automated-screening, and accommodation evidence.

## Roles and annual rhythm

Humans decide legal and employment-relations issues; independent reviewers sample notices and requests. AI drafts workpacks, but cannot make interpretations or decisions. Review quarterly and annually.
...
**Source and rights snapshot.** Use the guide's cited publisher source (https://ico.org.uk/for-organisations/uk-gdpr-guidance-and-resources/employment/) and check its current edition or status before use. This plan uses original operational language and does not reproduce protected requirements, assessment questions, mappings, or branded templates. A named human engagement owner confirms applicability and source rights.

**Guide-specific planning input.** Maintain lifecycle processing, guidance-watch, hiring, retention, health, monitoring, biometric, home-working, sharing, request, automated-screening, and accommodation evidence.
...
### 2. Operating evidence for UK employment data protection

- **Request and owner:** Time-bounded design/operating records, asset/configuration, maintenance, test/exercise, supplier, and corrective-action records, selected because this guide focuses on maintain lifecycle processing, guidance-watch, hiring, retention, health, monitoring, biometric, home-working, sharing, request, automated-screening, and accommodation evidence., from engineering, safety, operations, and supplier owners.
