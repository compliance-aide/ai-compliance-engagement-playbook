...
**Source and rights snapshot.** Use the guide's cited publisher source (https://eur-lex.europa.eu/legal-content/en/LSU/?uri=CELEX%3A32024R1183) and check its current edition or status before use. This plan uses original operational language and does not reproduce protected requirements, assessment questions, mappings, or branded templates. A named human engagement owner confirms applicability and source rights.

**Guide-specific planning input.** Determine declared organizational role, identity and data flows, accountable owners, onboarding, authentication, consent, interoperability, incident, and service-change evidence.
...
### 2. Operating evidence for EU eIDAS 2.0

- **Request and owner:** Time-bounded impact analysis, plan/version, exercise, communications, recovery, supplier, and corrective-action records, selected because this guide focuses on determine declared organizational role, identity and data flows, accountable owners, onboarding, authentication, consent, interoperability, incident, and service-change evidence., from resilience, service, incident, and supplier owners.
