...
**Source and rights snapshot.** Use the guide's cited publisher source (https://www.iso.org/standard/54204.html) and check its current edition or status before use. This plan uses original operational language and does not reproduce protected requirements, assessment questions, mappings, or branded templates. A named human engagement owner confirms applicability and source rights.

**Guide-specific planning input.** Maintain travel scope, traveller categories, destinations, threat and health inputs, risk decisions, advisories, vendor dependencies, emergency contacts, incident records, and improvement evidence.
...
### 2. Operating evidence for ISO 31030:2021 travel-risk management

- **Request and owner:** Time-bounded impact analysis, plan/version, exercise, communications, recovery, supplier, and corrective-action records, selected because this guide focuses on maintain travel scope, traveller categories, destinations, threat and health inputs, risk decisions, advisories, vendor dependencies, emergency contacts, incident records, and improvement evidence., from resilience, service, incident, and supplier owners.
