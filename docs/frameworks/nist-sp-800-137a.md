# NIST SP 800-137A continuous-monitoring program-assessment engagement guide

> Original operational guidance, not NIST text, an assessment conclusion, a control-effectiveness determination, or a compliance claim. Confirm current material through [NIST SP 800-137A](https://csrc.nist.gov/pubs/sp/800/137/a/final).

## Engagement focus

Assess the monitoring program as a program, not only the alerts it produces. Maintain a review record that connects monitoring strategy and objectives, asset and risk coverage, data sources, collection and analysis operations, governance, evidence quality, known blind spots, assessment questions, sampled evidence, observations, management responses, corrective actions, and review dates. Preserve assessor method, source, scope, limitations, and exceptions so the resulting record distinguishes a program-design observation from a conclusion about a specific safeguard.
