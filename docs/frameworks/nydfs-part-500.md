# NYDFS Part 500 — engagement guide

> Original operational guidance, not legal advice or a regulatory certification. Confirm current obligations at the [NYDFS cybersecurity resource center](https://www.dfs.ny.gov/cybersecurity).

## Engagement focus

Have an authorized owner determine coverage or exemption status. Maintain an annual calendar for governance, risk assessment, evidence collection, third-party oversight, exercises, incidents, approvals, and required notifications or certifications. Preserve versioned evidence and escalation records.

## Roles and annual rhythm

Program owners keep the operating record; counsel and authorized executives make coverage, materiality, certification, and submission decisions. Independent reviewers test completeness, timing, and conflicts. AI can run the calendar and prepare review packs; it cannot make legal judgments, sign certifications, manage an incident, or submit to NYDFS.
...
**Source and rights snapshot.** Use the guide's cited publisher source (https://www.dfs.ny.gov/cybersecurity) and check its current edition or status before use. This plan uses original operational language and does not reproduce protected requirements, assessment questions, mappings, or branded templates. A named human engagement owner confirms applicability and source rights.

**Guide-specific planning input.** Have an authorized owner determine coverage or exemption status. Maintain an annual calendar for governance, risk assessment, evidence collection, third-party oversight, exercises, incidents, approvals, and required notifications or certifications. Preserve versioned evidence and escalation records.
...
### 2. Operating evidence for NYDFS Part 500

- **Request and owner:** Time-bounded design/operating records, asset/configuration, maintenance, test/exercise, supplier, and corrective-action records, selected because this guide focuses on have an authorized owner determine coverage or exemption status. maintain an annual calendar for governance, risk assessment, evidence collection, third-party oversight, exercises, incidents, approvals, and required notifications or certifications. preserve versioned evidence and escalation records., from engineering, safety, operations, and supplier owners.
