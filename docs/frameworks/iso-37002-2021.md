...
### 2. Operating evidence for ISO 37002:2021 whistleblowing management

- **Request and owner:** Time-bounded design/operating records, asset/configuration, maintenance, test/exercise, supplier, and corrective-action records, selected because this guide focuses on maintain reporting channels, protected-access boundaries, intake records, triage authority, impartiality safeguards, investigation handoffs, retaliation-risk handling, case closure, and program-improvement evidence., from engineering, safety, operations, and supplier owners.
