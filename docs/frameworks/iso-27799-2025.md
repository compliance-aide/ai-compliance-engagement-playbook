...
**Source and rights snapshot.** Use the guide's cited publisher source (https://www.iso.org/standard/84647.html) and check its current edition or status before use. This plan uses original operational language and does not reproduce protected requirements, assessment questions, mappings, or branded templates. A named human engagement owner confirms applicability and source rights.

**Guide-specific planning input.** Maintain care-context scope, information flows, access decisions, workforce roles, supplier dependencies, security events, continuity records, and evidence linking safeguards to patient-information handling.
...
### 2. Operating evidence for ISO 27799:2025 health-information security

- **Request and owner:** Time-bounded impact analysis, plan/version, exercise, communications, recovery, supplier, and corrective-action records, selected because this guide focuses on maintain care-context scope, information flows, access decisions, workforce roles, supplier dependencies, security events, continuity records, and evidence linking safeguards to patient-information handling., from resilience, service, incident, and supplier owners.
