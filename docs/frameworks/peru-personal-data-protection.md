# Peru personal-data protection — engagement guide

> Original operational guidance, not legal advice. Check the [Peruvian authority’s regulatory hub](https://www.gob.pe/institucion/anpd/normas-legales) for current materials.

## Engagement focus

Maintain data handling, rights, notice, consent, security-event, marketing, processor, transfer, and accountable-role evidence. Reassess workflows annually and refresh evidence quarterly after service or guidance change.

## Roles and annual rhythm

Operators maintain services and processor records; independent reviewers trace workflows to configuration and contract proof. AI locates stale attestations and drafts audit packets, but cannot appoint roles, decide rights requests, make legal conclusions, or file externally.
...
**Source and rights snapshot.** Use the guide's cited publisher source (https://www.gob.pe/institucion/anpd/normas-legales) and check its current edition or status before use. This plan uses original operational language and does not reproduce protected requirements, assessment questions, mappings, or branded templates. A named human engagement owner confirms applicability and source rights.

**Guide-specific planning input.** Maintain data handling, rights, notice, consent, security-event, marketing, processor, transfer, and accountable-role evidence. Reassess workflows annually and refresh evidence quarterly after service or guidance change.
...
### 2. Operating evidence for Peru personal-data protection

- **Request and owner:** Time-bounded design/operating records, asset/configuration, maintenance, test/exercise, supplier, and corrective-action records, selected because this guide focuses on maintain data handling, rights, notice, consent, security-event, marketing, processor, transfer, and accountable-role evidence. reassess workflows annually and refresh evidence quarterly after service or guidance change., from engineering, safety, operations, and supplier owners.
