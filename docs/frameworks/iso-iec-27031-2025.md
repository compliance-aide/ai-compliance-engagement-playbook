...
**Source and rights snapshot.** Use the guide's cited publisher source (https://www.iso.org/standard/80975.html) and check its current edition or status before use. This plan uses original operational language and does not reproduce protected requirements, assessment questions, mappings, or branded templates. A named human engagement owner confirms applicability and source rights.

**Guide-specific planning input.** Maintain critical-service dependencies, recovery objectives, readiness design, supplier commitments, continuity tests, incident-to-recovery records, exception decisions, improvement actions, and evidence of exercised capability.
...
### 2. Operating evidence for ISO/IEC 27031:2025 ICT readiness

- **Request and owner:** Time-bounded impact analysis, plan/version, exercise, communications, recovery, supplier, and corrective-action records, selected because this guide focuses on maintain critical-service dependencies, recovery objectives, readiness design, supplier commitments, continuity tests, incident-to-recovery records, exception decisions, improvement actions, and evidence of exercised capability., from resilience, service, incident, and supplier owners.
