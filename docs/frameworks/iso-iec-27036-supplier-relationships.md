# ISO/IEC 27036 supplier relationships — engagement guide

> Original operational guidance, not ISO content or legal advice. Check the [ISO/IEC 27036-2 record](https://www.iso.org/standard/82060.html).

## Engagement focus

Maintain supplier criticality, services, access, dependencies, owner, contract, assurance, change, subcontracting, incident, exit, and exception evidence.
...
### 2. Operating evidence for ISO/IEC 27036 supplier relationships

- **Request and owner:** Time-bounded impact analysis, plan/version, exercise, communications, recovery, supplier, and corrective-action records, selected because this guide focuses on maintain supplier criticality, services, access, dependencies, owner, contract, assurance, change, subcontracting, incident, exit, and exception evidence., from resilience, service, incident, and supplier owners.
