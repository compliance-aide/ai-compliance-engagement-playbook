# CTPAT — supply-chain program engagement guide

> Original operational guidance, not CBP criteria or a program submission. Consult [CBP CTPAT](https://www.cbp.gov/border-security/ports-entry/cargo-security/CTPAT).

## Engagement focus

Confirm entity category and participation status; maintain international map, partner verification, contract, annual profile-review, reassessment, validation-interview, and walkthrough evidence.
...
**Source and rights snapshot.** Use the guide's cited publisher source (https://www.cbp.gov/border-security/ports-entry/cargo-security/CTPAT) and check its current edition or status before use. This plan uses original operational language and does not reproduce protected requirements, assessment questions, mappings, or branded templates. A named human engagement owner confirms applicability and source rights.

**Guide-specific planning input.** Confirm entity category and participation status; maintain international map, partner verification, contract, annual profile-review, reassessment, validation-interview, and walkthrough evidence.
...
### 2. Operating evidence for CTPAT — supply-chain program

- **Request and owner:** Time-bounded scope/inventory, policy/procedure, operating, technical, change, exception, and review records, selected because this guide focuses on confirm entity category and participation status; maintain international map, partner verification, contract, annual profile-review, reassessment, validation-interview, and walkthrough evidence., from business, security, service, and supplier owners.
