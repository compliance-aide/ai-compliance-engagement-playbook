...
> Original operational guidance, not EU legal advice or a transition conclusion. Track [Regulation (EU) 2024/1624](https://eur-lex.europa.eu/legal-content/EN/ALL/?uri=CELEX%3A32024R1624) and national developments.

## Engagement focus

Maintain country/entity matrix, current local baseline, milestones, owners, customer lifecycle, ownership, monitoring, reporting, records, and legal-horizon evidence.
...
**Source and rights snapshot.** Use the guide's cited publisher source (https://eur-lex.europa.eu/legal-content/EN/ALL/?uri=CELEX%3A32024R1624) and check its current edition or status before use. This plan uses original operational language and does not reproduce protected requirements, assessment questions, mappings, or branded templates. A named human engagement owner confirms applicability and source rights.

**Guide-specific planning input.** Maintain country/entity matrix, current local baseline, milestones, owners, customer lifecycle, ownership, monitoring, reporting, records, and legal-horizon evidence.
...
### 2. Operating evidence for EU AML package transition

- **Request and owner:** Time-bounded governance, transaction/process, access/change, exception, supervisory-review, and remediation records, selected because this guide focuses on maintain country/entity matrix, current local baseline, milestones, owners, customer lifecycle, ownership, monitoring, reporting, records, and legal-horizon evidence., from business, risk, compliance, finance, and operational owners.
