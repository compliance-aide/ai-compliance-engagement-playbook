# NIST SP 800-39 — engagement guide

> Original operational guidance, not risk acceptance. Consult the current
> [NIST risk-management source](https://csrc.nist.gov/pubs/sp/800/39/final).

## Engagement focus

Establish organizational risk context and decision rights; align mission and
business objectives with system work; maintain a single risk picture and
escalation path; revisit material changes, risk appetite, and resource decisions;
and provide leadership a source-linked annual risk narrative.

## Roles and annual rhythm

Operators own risk inputs, decisions, and evidence. Independent reviewers test
...
**Source and rights snapshot.** Use the guide's cited publisher source (https://csrc.nist.gov/pubs/sp/800/39/final) and check its current edition or status before use. This plan uses original operational language and does not reproduce protected requirements, assessment questions, mappings, or branded templates. A named human engagement owner confirms applicability and source rights.

**Guide-specific planning input.** Establish organizational risk context and decision rights; align mission and business objectives with system work; maintain a single risk picture and escalation path; revisit material changes, risk appetite, and resource decisions; and provide leadership a source-linked annual risk narrative.
...
### 2. Operating evidence for NIST SP 800-39

- **Request and owner:** Time-bounded scope/inventory, policy/procedure, operating, technical, change, exception, and review records, selected because this guide focuses on establish organizational risk context and decision rights; align mission and business objectives with system work; maintain a single risk picture and escalation path; revisit material changes, risk appetite, and resource decisions; and provide leadership a source-linked annual risk narrative., from business, security, service, and supplier owners.
