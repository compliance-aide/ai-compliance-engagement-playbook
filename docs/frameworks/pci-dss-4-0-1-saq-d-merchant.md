# PCI DSS v4.0.1 SAQ D for Merchants engagement guide
...
Treat the merchant SAQ D workflow as a comprehensive, profile-specific self-assessment program—not as a substitute for an accurate PCI DSS scope decision or a generic control checklist. Maintain a controlled scope statement covering payment acceptance, account-data flows, merchant systems and services, people, locations, access, third parties, connected environments, and material changes. Keep the evidence register traceable to responsible owners, the annual assessment record, risk and exception decisions, and recipient requirements. Escalate scope or eligibility ambiguity to management and the receiving entity before a submission is prepared.
