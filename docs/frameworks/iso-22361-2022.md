...
### 2. Operating evidence for ISO 22361:2022 — crisis-management

- **Request and owner:** Time-bounded design/operating records, asset/configuration, maintenance, test/exercise, supplier, and corrective-action records, selected because this guide focuses on maintain authority, escalation, roles, delegation, contacts, protected communications, decision logs, exercises, lessons, and corrective-action records., from engineering, safety, operations, and supplier owners.
