# NIST IR 8212 ISCM assessment-methodology engagement guide

> Original operational guidance, not NIST text, a tool endorsement, an assessment conclusion, or a compliance claim. Confirm current material through [NIST IR 8212](https://csrc.nist.gov/pubs/ir/8212/final).

## Engagement focus

Use a repeatable assessment-methodology record to examine a continuous-monitoring program’s design and operation. Maintain approved scope, assessment questions, evidence sources, selection rationale, observations, reviewer judgments, limitations, management responses, corrective actions, and review dates. Treat any reference implementation or workbook as a support tool, not as a production system, an automatic judgment engine, or proof that an assessment result is valid. Preserve methodology changes and human rationale so each assessment can be independently reconstructed.
