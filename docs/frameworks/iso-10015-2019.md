...
**Source and rights snapshot.** Use the guide's cited publisher source (https://www.iso.org/standard/69459.html) and check its current edition or status before use. This plan uses original operational language and does not reproduce protected requirements, assessment questions, mappings, or branded templates. A named human engagement owner confirms applicability and source rights.

**Guide-specific planning input.** Maintain role and competence needs, evidence of capability, learning plans, completion records, effectiveness review, workforce-access boundaries, exceptions, and improvement actions.
...
### 2. Operating evidence for ISO 10015:2019 competence management

- **Request and owner:** Time-bounded scope/inventory, policy/procedure, operating, technical, change, exception, and review records, selected because this guide focuses on maintain role and competence needs, evidence of capability, learning plans, completion records, effectiveness review, workforce-access boundaries, exceptions, and improvement actions., from business, security, service, and supplier owners.
