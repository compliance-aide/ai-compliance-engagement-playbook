...
**Guide-specific planning input.** Maintain industrial asset/system/supplier boundary, approved architecture inventory, risk register, remote-access, recovery, vulnerability, maintenance, and service evidence.
...
### 2. Operating evidence for IEC 62443 — industrial cybersecurity

- **Request and owner:** Time-bounded design/operating records, asset/configuration, maintenance, test/exercise, supplier, and corrective-action records, selected because this guide focuses on maintain industrial asset/system/supplier boundary, approved architecture inventory, risk register, remote-access, recovery, vulnerability, maintenance, and service evidence., from engineering, safety, operations, and supplier owners.
