# Mauritius Data Protection Act — engagement guide

> Original operational guidance, not legal advice. Confirm current rules with the [Mauritius Data Protection Office](https://dataprotection.govmu.org/Pages/The%20Law/Data-Protection-Act-2017.aspx).

## Engagement focus

Refresh data, service, processor, access, incident, registration-lifecycle, automated-processing, transfer, and exception evidence; exercise requests and incidents.
...
**Source and rights snapshot.** Use the guide's cited publisher source (https://dataprotection.govmu.org/Pages/The%20Law/Data-Protection-Act-2017.aspx) and check its current edition or status before use. This plan uses original operational language and does not reproduce protected requirements, assessment questions, mappings, or branded templates. A named human engagement owner confirms applicability and source rights.

**Guide-specific planning input.** Refresh data, service, processor, access, incident, registration-lifecycle, automated-processing, transfer, and exception evidence; exercise requests and incidents.
...
### 2. Operating evidence for Mauritius Data Protection Act

- **Request and owner:** Time-bounded design/operating records, asset/configuration, maintenance, test/exercise, supplier, and corrective-action records, selected because this guide focuses on refresh data, service, processor, access, incident, registration-lifecycle, automated-processing, transfer, and exception evidence; exercise requests and incidents., from engineering, safety, operations, and supplier owners.
