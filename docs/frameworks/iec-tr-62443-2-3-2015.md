...
**Source and rights snapshot.** Use the guide's cited publisher source (https://webstore.iec.ch/en/publication/22811) and check its current edition or status before use. This plan uses original operational language and does not reproduce protected requirements, assessment questions, mappings, or branded templates. A named human engagement owner confirms applicability and source rights.

**Guide-specific planning input.** Maintain an industrial patch-management record that connects IACS assets, software and supplier dependencies, accountable operations and maintenance owners, safety and process constraints, vendor advisories, authorized test evidence, patch and compensating-decision records, incidents, remediation, and independent review. Preserve the separation between AI-assisted evidence organization and accountable human decisions about patching, maintenance windows, safety, operational continuity, and acceptable risk.
...
### 2. Operating evidence for IEC TR 62443-2-3:2015 IACS patch-management

- **Request and owner:** Time-bounded inventory, evaluation, monitoring, oversight, release, feedback, and incident records, selected because this guide focuses on maintain an industrial patch-management record that connects iacs assets, software and supplier dependencies, accountable operations and maintenance owners, safety and process constraints, vendor advisories, authorized test evidence, patch and compensating-decision records, incidents, remediation, and independent review. preserve the separation between ai-assisted evidence organization and accountable human decisions about patching, maintenance windows, safety, operational continuity, and acceptable risk., from AI governance, product, model, and risk owners.
