...
**Source and rights snapshot.** Use the guide's cited publisher source (https://www.iso.org/standard/27001) and check its current edition or status before use. This plan uses original operational language and does not reproduce protected requirements, assessment questions, mappings, or branded templates. A named human engagement owner confirms applicability and source rights.

**Guide-specific planning input.** Define the information-security management boundary; refresh organizational context and information-risk decisions; maintain applicability and rationale records without recreating the standard; govern changes and suppliers; exercise incident and continuity capability; review performance and corrective action.
