# ISO/IEC 27050 electronic discovery — engagement guide

> Original operational guidance, not ISO content, legal advice, or a preservation decision. Check the [ISO/IEC 27050-1 record](https://www.iso.org/standard/78647.html); do not place ISO text in AI prompts.

## Engagement focus

Maintain legal-hold authority, matter scope, data-source inventory, preservation and collection records, access restrictions, review decisions, production approvals, chain-of-custody, and closure evidence.

## Roles and annual rhythm

Legal and authorized matter owners make preservation and production decisions; independent reviewers verify handling evidence. AI inventories approved records and drafts status questions, but cannot identify legal obligations, collect data, or produce records. Test readiness annually and review on each matter.
...
**Source and rights snapshot.** Use the guide's cited publisher source (https://www.iso.org/standard/78647.html) and check its current edition or status before use. This plan uses original operational language and does not reproduce protected requirements, assessment questions, mappings, or branded templates. A named human engagement owner confirms applicability and source rights.

**Guide-specific planning input.** Maintain legal-hold authority, matter scope, data-source inventory, preservation and collection records, access restrictions, review decisions, production approvals, chain-of-custody, and closure evidence.
...
### 2. Operating evidence for ISO/IEC 27050 electronic discovery

- **Request and owner:** Time-bounded scope/inventory, policy/procedure, operating, technical, change, exception, and review records, selected because this guide focuses on maintain legal-hold authority, matter scope, data-source inventory, preservation and collection records, access restrictions, review decisions, production approvals, chain-of-custody, and closure evidence., from business, security, service, and supplier owners.
