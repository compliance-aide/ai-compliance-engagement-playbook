...
**Source and rights snapshot.** Use the guide's cited publisher source (https://www.canada.ca/en/government/system/digital-government/digital-government-innovations/cloud-services/government-canada-security-control-profile-cloud-based-it-services.html) and check its current edition or status before use. This plan uses original operational language and does not reproduce protected requirements, assessment questions, mappings, or branded templates. A named human engagement owner confirms applicability and source rights.

**Guide-specific planning input.** For a government cloud service, maintain clear responsibility boundaries, service and data context, provider evidence, customer-operating assumptions, interface changes, material incidents, remediation, and decision records that can be reviewed over time.
...
### 2. Operating evidence for Canada GC cloud-security profile

- **Request and owner:** Time-bounded impact analysis, plan/version, exercise, communications, recovery, supplier, and corrective-action records, selected because this guide focuses on for a government cloud service, maintain clear responsibility boundaries, service and data context, provider evidence, customer-operating assumptions, interface changes, material incidents, remediation, and decision records that can be reviewed over time., from resilience, service, incident, and supplier owners.
