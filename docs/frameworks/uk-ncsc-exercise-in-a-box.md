# UK NCSC Exercise in a Box engagement guide

> Original operational guidance, not NCSC exercise content, an incident-response command, a readiness certification, or a compliance claim. Confirm current material through [NCSC Exercise in a Box](https://www.ncsc.gov.uk/section/exercise-in-a-box/overview) and the organization’s approved security, legal, privacy, communications, and operational decisions.

## Engagement focus

Operate a repeatable cyber-exercise program that uses appropriate scenarios to test people, processes, dependencies, communications, and recovery decisions in a safe environment. Connect each exercise to scope, participants, facilitation, observer independence, evidence collection, findings, accountable actions, and follow-up validation. Treat exercises as learning events: an exercise result does not prove real-event performance, compliance, or that any person or team is at fault.
