...
**Source and rights snapshot.** Use the guide's cited publisher source (https://www.iso.org/standard/72311.html) and check its current edition or status before use. This plan uses original operational language and does not reproduce protected requirements, assessment questions, mappings, or branded templates. A named human engagement owner confirms applicability and source rights.

**Guide-specific planning input.** Maintain public intake routes, reporter communication, affected-product records, coordination owners, disclosure decisions, remediation communications, exceptions, timelines, and post-incident improvements.
...
### 2. Operating evidence for ISO/IEC 29147:2018 vulnerability disclosure

- **Request and owner:** Time-bounded impact analysis, plan/version, exercise, communications, recovery, supplier, and corrective-action records, selected because this guide focuses on maintain public intake routes, reporter communication, affected-product records, coordination owners, disclosure decisions, remediation communications, exceptions, timelines, and post-incident improvements., from resilience, service, incident, and supplier owners.
