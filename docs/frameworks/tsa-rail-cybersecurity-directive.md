# TSA rail cybersecurity directive engagement guide

> Original operational guidance, not TSA directive text, a determination of coverage, or an operational-security assessment. Confirm current applicability and directive version through the [TSA rail cybersecurity directive notice](https://www.tsa.gov/sites/default/files/tsa-security-directive-1580_82-2022-01c-and-memo-508c.pdf).

## Engagement focus

Maintain an owner-approved record of covered rail operations, critical cyber-system scope, plans and exercises, evidence of operational safeguards, material changes, incidents, testing, remedial actions, and official communications.
...
**Source and rights snapshot.** Use the guide's cited publisher source (https://www.tsa.gov/sites/default/files/tsa-security-directive-1580_82-2022-01c-and-memo-508c.pdf) and check its current edition or status before use. This plan uses original operational language and does not reproduce protected requirements, assessment questions, mappings, or branded templates. A named human engagement owner confirms applicability and source rights.

**Guide-specific planning input.** Maintain an owner-approved record of covered rail operations, critical cyber-system scope, plans and exercises, evidence of operational safeguards, material changes, incidents, testing, remedial actions, and official communications.
...
### 2. Operating evidence for TSA rail cybersecurity directive

- **Request and owner:** Time-bounded design/operating records, asset/configuration, maintenance, test/exercise, supplier, and corrective-action records, selected because this guide focuses on maintain an owner-approved record of covered rail operations, critical cyber-system scope, plans and exercises, evidence of operational safeguards, material changes, incidents, testing, remedial actions, and official communications., from engineering, safety, operations, and supplier owners.
