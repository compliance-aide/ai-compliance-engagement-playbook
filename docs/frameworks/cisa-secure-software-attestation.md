# CISA secure-software attestation readiness — engagement guide

> Original operational guidance, not an attestation, legal conclusion, or authorization to submit. Consult the [CISA attestation resource](https://www.cisa.gov/resources-tools/resources/secure-software-development-attestation-form) and the applicable solicitation.

## Engagement focus

Maintain the requested-product boundary, responsible parties, development and supply-chain evidence, exception analysis, release records, supporting artifacts, and customer communication history.
...
**Source and rights snapshot.** Use the guide's cited publisher source (https://www.cisa.gov/resources-tools/resources/secure-software-development-attestation-form) and check its current edition or status before use. This plan uses original operational language and does not reproduce protected requirements, assessment questions, mappings, or branded templates. A named human engagement owner confirms applicability and source rights.

**Guide-specific planning input.** Maintain the requested-product boundary, responsible parties, development and supply-chain evidence, exception analysis, release records, supporting artifacts, and customer communication history.
...
### 2. Operating evidence for CISA secure-software attestation readiness

- **Request and owner:** Time-bounded scope/inventory, policy/procedure, operating, technical, change, exception, and review records, selected because this guide focuses on maintain the requested-product boundary, responsible parties, development and supply-chain evidence, exception analysis, release records, supporting artifacts, and customer communication history., from business, security, service, and supplier owners.
