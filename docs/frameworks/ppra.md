# PPRA — engagement guide

> Original operational guidance, not legal advice or a certification. Consult the [U.S. Education Department PPRA explanation](https://studentprivacy.ed.gov/faq/what-protection-pupil-rights-amendment-ppra).

## Engagement focus

Identify covered programs and student-facing surveys, evaluations, marketing, data-sale activities, notices, consent/opt-out paths, vendors, dates, and complaint evidence.

## Roles and annual rhythm

Operators maintain the calendar, notices, terms, and records; independent reviewers test population completeness and choices. AI flags missing artifacts, but cannot determine coverage, override parental choices, or send required notices.
...
**Source and rights snapshot.** Use the guide's cited publisher source (https://studentprivacy.ed.gov/faq/what-protection-pupil-rights-amendment-ppra) and check its current edition or status before use. This plan uses original operational language and does not reproduce protected requirements, assessment questions, mappings, or branded templates. A named human engagement owner confirms applicability and source rights.

**Guide-specific planning input.** Identify covered programs and student-facing surveys, evaluations, marketing, data-sale activities, notices, consent/opt-out paths, vendors, dates, and complaint evidence.
