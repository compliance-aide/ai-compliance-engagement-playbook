...
> Original operational guidance, not ICH content or a risk decision. See the [ICH Q9(R1) final document](https://database.ich.org/sites/default/files/ICH_Q9%28R1%29_Guideline_Step4_2025_0115.pdf).

## Engagement focus

Maintain risk context, accountable decision-maker, evidence date, uncertainty, trigger, outcome, supply implication, change history, and open-assumption records.

## Roles and annual rhythm

Qualified humans set criteria and approve decisions; independent reviewers test provenance. AI detects stale risks and drafts evidence packs, but cannot accept risk or judge effectiveness. Review quarterly and annually.
...
**Source and rights snapshot.** Use the guide's cited publisher source (https://database.ich.org/sites/default/files/ICH_Q9%28R1%29_Guideline_Step4_2025_0115.pdf) and check its current edition or status before use. This plan uses original operational language and does not reproduce protected requirements, assessment questions, mappings, or branded templates. A named human engagement owner confirms applicability and source rights.

**Guide-specific planning input.** Maintain risk context, accountable decision-maker, evidence date, uncertainty, trigger, outcome, supply implication, change history, and open-assumption records.
...
### 2. Operating evidence for ICH Q9(R1) quality-risk

- **Request and owner:** Time-bounded scope/inventory, policy/procedure, operating, technical, change, exception, and review records, selected because this guide focuses on maintain risk context, accountable decision-maker, evidence date, uncertainty, trigger, outcome, supply implication, change history, and open-assumption records., from business, security, service, and supplier owners.
