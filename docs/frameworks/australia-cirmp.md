# Australia CIRMP — engagement guide

> Original operational guidance, not a statutory scope or reporting conclusion. Check the [critical-infrastructure rules](https://www.legislation.gov.au/F2023L00112/latest).

## Engagement focus

Establish in-scope assets and accountable owner; maintain dependencies, all-hazards risk-program, treatment, exercise, incident, and annual-report evidence.
...
**Source and rights snapshot.** Use the guide's cited publisher source (https://www.legislation.gov.au/F2023L00112/latest) and check its current edition or status before use. This plan uses original operational language and does not reproduce protected requirements, assessment questions, mappings, or branded templates. A named human engagement owner confirms applicability and source rights.

**Guide-specific planning input.** Establish in-scope assets and accountable owner; maintain dependencies, all-hazards risk-program, treatment, exercise, incident, and annual-report evidence.
...
### 2. Operating evidence for Australia CIRMP

- **Request and owner:** Time-bounded impact analysis, plan/version, exercise, communications, recovery, supplier, and corrective-action records, selected because this guide focuses on establish in-scope assets and accountable owner; maintain dependencies, all-hazards risk-program, treatment, exercise, incident, and annual-report evidence., from resilience, service, incident, and supplier owners.
