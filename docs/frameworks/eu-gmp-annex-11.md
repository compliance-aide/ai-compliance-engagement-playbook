...
**Source and rights snapshot.** Use the guide's cited publisher source (https://health.ec.europa.eu/medicinal-products/eudralex/eudralex-volume-4_en) and check its current edition or status before use. This plan uses original operational language and does not reproduce protected requirements, assessment questions, mappings, or branded templates. A named human engagement owner confirms applicability and source rights.

**Guide-specific planning input.** Maintain GxP system estate, intended use, data owners, suppliers, validation, change, release, access, review, recovery, interface, deviation, and remediation evidence.
...
### 2. Operating evidence for EU GMP Annex 11 — computerized-systems

- **Request and owner:** Time-bounded impact analysis, plan/version, exercise, communications, recovery, supplier, and corrective-action records, selected because this guide focuses on maintain gxp system estate, intended use, data owners, suppliers, validation, change, release, access, review, recovery, interface, deviation, and remediation evidence., from resilience, service, incident, and supplier owners.
