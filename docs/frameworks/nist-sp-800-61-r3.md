# NIST SP 800-61 Revision 3 — incident-response engagement guide

> Original operational guidance, not NIST content or a reportability decision. Confirm status at the [NIST publication record](https://csrc.nist.gov/pubs/sp/800/61/r3/final).

## Engagement focus

Maintain incident preparation, detection sources, triage records, authority matrix, containment and recovery evidence, communications, lessons, risk integration, and improvement ownership.
...
**Source and rights snapshot.** Use the guide's cited publisher source (https://csrc.nist.gov/pubs/sp/800/61/r3/final) and check its current edition or status before use. This plan uses original operational language and does not reproduce protected requirements, assessment questions, mappings, or branded templates. A named human engagement owner confirms applicability and source rights.

**Guide-specific planning input.** Maintain incident preparation, detection sources, triage records, authority matrix, containment and recovery evidence, communications, lessons, risk integration, and improvement ownership.
...
### 2. Operating evidence for NIST SP 800-61 Revision 3 — incident-response

- **Request and owner:** Time-bounded impact analysis, plan/version, exercise, communications, recovery, supplier, and corrective-action records, selected because this guide focuses on maintain incident preparation, detection sources, triage records, authority matrix, containment and recovery evidence, communications, lessons, risk integration, and improvement ownership., from resilience, service, incident, and supplier owners.
