...
### 2. Operating evidence for ISO/IEC 27005:2022 — information-security risk

- **Request and owner:** Time-bounded impact analysis, plan/version, exercise, communications, recovery, supplier, and corrective-action records, selected because this guide focuses on maintain decision authorities, tolerances, assets, services, change, supplier, incident, vulnerability, assumptions, treatment, escalation, and remediation evidence., from resilience, service, incident, and supplier owners.
