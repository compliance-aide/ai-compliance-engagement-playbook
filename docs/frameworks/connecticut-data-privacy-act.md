...
**Source and rights snapshot.** Use the guide's cited publisher source (https://portal.ct.gov/AG/Sections/Privacy-/The-Connecticut-Data-Privacy-Act) and check its current edition or status before use. This plan uses original operational language and does not reproduce protected requirements, assessment questions, mappings, or branded templates. A named human engagement owner confirms applicability and source rights.

**Guide-specific planning input.** Track legal changes, collection, sharing, sensitive/minor-data, automated-decision, vendor, rights, opt-out, consent, notice, retention, and assessment evidence.
...
### 2. Operating evidence for Connecticut Data Privacy Act

- **Request and owner:** Time-bounded data-flow, notice/version, rights, retention, vendor, and incident records, selected because this guide focuses on track legal changes, collection, sharing, sensitive/minor-data, automated-decision, vendor, rights, opt-out, consent, notice, retention, and assessment evidence., from privacy, product, records, and vendor owners.
