# Wolfsberg financial-crime principles — engagement guide

> Original operational guidance, not Wolfsberg content, law, or endorsement. Check the [Wolfsberg resource library](https://wolfsberg-group.org/resources).

## Engagement focus

Define voluntary use case and local-law boundary; maintain governance, data, monitoring, investigation, third-party, outcome, automation, override, and remediation evidence.

## Roles and annual rhythm

Humans make alert, risk, customer, and regulatory decisions; independent audit challenges effectiveness. AI supports evidence and planning, but cannot autonomously disposition alerts or assert compliance. Review quarterly and annually.
...
**Source and rights snapshot.** Use the guide's cited publisher source (https://wolfsberg-group.org/resources) and check its current edition or status before use. This plan uses original operational language and does not reproduce protected requirements, assessment questions, mappings, or branded templates. A named human engagement owner confirms applicability and source rights.

**Guide-specific planning input.** Define voluntary use case and local-law boundary; maintain governance, data, monitoring, investigation, third-party, outcome, automation, override, and remediation evidence.
...
### 2. Operating evidence for Wolfsberg financial-crime principles

- **Request and owner:** Time-bounded governance, transaction/process, access/change, exception, supervisory-review, and remediation records, selected because this guide focuses on define voluntary use case and local-law boundary; maintain governance, data, monitoring, investigation, third-party, outcome, automation, override, and remediation evidence., from business, risk, compliance, finance, and operational owners.
