# U.S. BSA / FinCEN AML program — engagement guide

> Original operational guidance, not legal advice or a filing decision. Check the [FinCEN BSA resource](https://www.fincen.gov/resources/statutes-and-regulations/bank-secrecy-act).

## Engagement focus

Maintain entity, product, geography, regulator, risk, program, data, case, filing/record calendar, training, third-party, exception, and remediation evidence.
...
**Source and rights snapshot.** Use the guide's cited publisher source (https://www.fincen.gov/resources/statutes-and-regulations/bank-secrecy-act) and check its current edition or status before use. This plan uses original operational language and does not reproduce protected requirements, assessment questions, mappings, or branded templates. A named human engagement owner confirms applicability and source rights.

**Guide-specific planning input.** Maintain entity, product, geography, regulator, risk, program, data, case, filing/record calendar, training, third-party, exception, and remediation evidence.
...
### 2. Operating evidence for U.S. BSA / FinCEN AML program

- **Request and owner:** Time-bounded governance, transaction/process, access/change, exception, supervisory-review, and remediation records, selected because this guide focuses on maintain entity, product, geography, regulator, risk, program, data, case, filing/record calendar, training, third-party, exception, and remediation evidence., from business, risk, compliance, finance, and operational owners.
