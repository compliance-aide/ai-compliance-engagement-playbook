# MHRA GxP data-integrity engagement guide

> Original operational guidance, not MHRA guidance or an investigation conclusion. Consult the [MHRA data-integrity guidance](https://www.gov.uk/government/publications/guidance-on-gxp-data-integrity).

## Engagement focus

Maintain GxP data lifecycle, outsourced flows, criticality, lineage, anomalous changes, training, investigations, CAPA, provenance, and closure evidence.

## Roles and annual rhythm

Humans approve investigations and CAPA closure; independent reviewers use frozen sample ledgers. AI finds anomalies and gaps, but cannot accept risk or reach conclusions. Review quarterly and annually.
...
**Source and rights snapshot.** Use the guide's cited publisher source (https://www.gov.uk/government/publications/guidance-on-gxp-data-integrity) and check its current edition or status before use. This plan uses original operational language and does not reproduce protected requirements, assessment questions, mappings, or branded templates. A named human engagement owner confirms applicability and source rights.

**Guide-specific planning input.** Maintain GxP data lifecycle, outsourced flows, criticality, lineage, anomalous changes, training, investigations, CAPA, provenance, and closure evidence.
...
### 2. Operating evidence for MHRA GxP data-integrity

- **Request and owner:** Time-bounded scope/inventory, policy/procedure, operating, technical, change, exception, and review records, selected because this guide focuses on maintain gxp data lifecycle, outsourced flows, criticality, lineage, anomalous changes, training, investigations, capa, provenance, and closure evidence., from business, security, service, and supplier owners.
