...
**Source and rights snapshot.** Use the guide's cited publisher source (https://www.sic.gov.co/proteccion-de-datos-personales) and check its current edition or status before use. This plan uses original operational language and does not reproduce protected requirements, assessment questions, mappings, or branded templates. A named human engagement owner confirms applicability and source rights.

**Guide-specific planning input.** Maintain use and disclosure inventory, notices, authorizations, complaints, supplier oversight, registration-review, and public-claim evidence. Test requests and vendor evidence quarterly and reconcile public claims annually.
...
### 2. Operating evidence for Colombia personal-data protection

- **Request and owner:** Time-bounded design/operating records, asset/configuration, maintenance, test/exercise, supplier, and corrective-action records, selected because this guide focuses on maintain use and disclosure inventory, notices, authorizations, complaints, supplier oversight, registration-review, and public-claim evidence. test requests and vendor evidence quarterly and reconcile public claims annually., from engineering, safety, operations, and supplier owners.
