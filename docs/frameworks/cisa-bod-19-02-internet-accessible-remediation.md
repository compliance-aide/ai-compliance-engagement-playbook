...
Read the [original directive](https://www.cisa.gov/sites/default/files/bod-19-02.pdf), [directive page](https://www.cisa.gov/news-events/directives/bod-19-02-vulnerability-remediation-requirements-internet-accessible-systems) and current agency direction. **Current applicability requires verification:** a possible successor, BOD 26-04, was surfaced during research, but its official page returned 403 and official indexed results did not confirm supersession. Do not assume either that BOD 19-02 remains the controlling rule or that it has been revoked. The agency authority must resolve status before applying directive-specific deadlines or reporting instructions. Preserve historical records under their original source version.
