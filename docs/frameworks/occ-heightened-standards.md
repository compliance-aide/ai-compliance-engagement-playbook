# OCC Heightened Standards — engagement guide

> Original operational guidance, not legal advice or board action. Confirm live scope and rulemaking at the [OCC proposal notice](https://www.occ.treas.gov/news-issuances/bulletins/2025/bulletin-2025-51.html).

## Engagement focus

Maintain covered-status, board-facing risk governance, strategic, control, escalation, remediation, and rule-change evidence.
...
**Source and rights snapshot.** Use the guide's cited publisher source (https://www.occ.treas.gov/news-issuances/bulletins/2025/bulletin-2025-51.html) and check its current edition or status before use. This plan uses original operational language and does not reproduce protected requirements, assessment questions, mappings, or branded templates. A named human engagement owner confirms applicability and source rights.

**Guide-specific planning input.** Maintain covered-status, board-facing risk governance, strategic, control, escalation, remediation, and rule-change evidence.
...
### 2. Operating evidence for OCC Heightened Standards

- **Request and owner:** Time-bounded scope/inventory, policy/procedure, operating, technical, change, exception, and review records, selected because this guide focuses on maintain covered-status, board-facing risk governance, strategic, control, escalation, remediation, and rule-change evidence., from business, security, service, and supplier owners.
