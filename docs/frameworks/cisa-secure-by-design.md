...
Maintain product portfolio, supported versions, design-risk decisions, secure-development, release, vulnerability, customer-impact, remediation, and claim-evidence records.

## Roles and annual rhythm

Product owners make release decisions; independent reviewers sample release-to-impact evidence. AI correlates artifacts and unsupported claims, but cannot make product assertions or certify. Review quarterly and annually.
...
**Source and rights snapshot.** Use the guide's cited publisher source (https://www.cisa.gov/securebydesign/blogs) and check its current edition or status before use. This plan uses original operational language and does not reproduce protected requirements, assessment questions, mappings, or branded templates. A named human engagement owner confirms applicability and source rights.

**Guide-specific planning input.** Maintain product portfolio, supported versions, design-risk decisions, secure-development, release, vulnerability, customer-impact, remediation, and claim-evidence records.
...
### 2. Operating evidence for CISA Secure by Design — product-security

- **Request and owner:** Time-bounded scope/inventory, policy/procedure, operating, technical, change, exception, and review records, selected because this guide focuses on maintain product portfolio, supported versions, design-risk decisions, secure-development, release, vulnerability, customer-impact, remediation, and claim-evidence records., from business, security, service, and supplier owners.
