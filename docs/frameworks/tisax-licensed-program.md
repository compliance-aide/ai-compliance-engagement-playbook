# TISAX — licensed-program engagement guide

> Original operational guidance, not VDA/ENX content, a score, or certification. Consult the [ENX participant handbook](https://portal.enx.com/handbook/tisax-participant-handbook.html).

## Engagement focus

Confirm customer-requested scope and locations with authorized parties; maintain information-flow, location, supplier, corrective-action, and readiness evidence.
...
**Source and rights snapshot.** Use the guide's cited publisher source (https://portal.enx.com/handbook/tisax-participant-handbook.html) and check its current edition or status before use. This plan uses original operational language and does not reproduce protected requirements, assessment questions, mappings, or branded templates. A named human engagement owner confirms applicability and source rights.

**Guide-specific planning input.** Confirm customer-requested scope and locations with authorized parties; maintain information-flow, location, supplier, corrective-action, and readiness evidence.
...
### 2. Operating evidence for TISAX — licensed-program

- **Request and owner:** Time-bounded scope/inventory, policy/procedure, operating, technical, change, exception, and review records, selected because this guide focuses on confirm customer-requested scope and locations with authorized parties; maintain information-flow, location, supplier, corrective-action, and readiness evidence., from business, security, service, and supplier owners.
