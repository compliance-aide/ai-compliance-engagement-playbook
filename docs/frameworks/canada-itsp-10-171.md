...
> Original operational guidance, not Canadian security-requirement text, a contractual determination, or an assessment conclusion. Confirm current scope through [ITSP.10.171](https://www.cyber.gc.ca/en/guidance/protecting-specified-information-non-government-canada-systems-and-organizations-itsp10171).

## Engagement focus

Maintain a contract-aware record of specified information, in-scope non-government systems, security-domain decisions, accountable owners, supplier handling, operating evidence, assessment results, changes, and remediation.
...
**Source and rights snapshot.** Use the guide's cited publisher source (https://www.cyber.gc.ca/en/guidance/protecting-specified-information-non-government-canada-systems-and-organizations-itsp10171) and check its current edition or status before use. This plan uses original operational language and does not reproduce protected requirements, assessment questions, mappings, or branded templates. A named human engagement owner confirms applicability and source rights.

**Guide-specific planning input.** Maintain a contract-aware record of specified information, in-scope non-government systems, security-domain decisions, accountable owners, supplier handling, operating evidence, assessment results, changes, and remediation.
...
### 2. Operating evidence for Canada ITSP.10.171 specified-information protection

- **Request and owner:** Time-bounded design/operating records, asset/configuration, maintenance, test/exercise, supplier, and corrective-action records, selected because this guide focuses on maintain a contract-aware record of specified information, in-scope non-government systems, security-domain decisions, accountable owners, supplier handling, operating evidence, assessment results, changes, and remediation., from engineering, safety, operations, and supplier owners.
