# Virginia Consumer Data Protection Act — engagement guide

> Original operational guidance, not legal advice. Check the live [Virginia Code CDPA chapter](https://law.lis.virginia.gov/vacode/title59.1/chapter53/) at planning time.

## Engagement focus

Counsel records changes; operators refresh data, purpose, recipient, retention, sensitive-data, rights, appeals, notices, consent, opt-out, assessment, and processor evidence.

## Roles and annual rhythm

Privacy owners operate workflows; independent reviewers trace disclosures to systems and remediation. AI reconciles inventories and drafts test plans, but cannot decide applicability, authenticate requesters, approve risk, or submit anything. Review quarterly and annually.
...
**Source and rights snapshot.** Use the guide's cited publisher source (https://law.lis.virginia.gov/vacode/title59.1/chapter53/) and check its current edition or status before use. This plan uses original operational language and does not reproduce protected requirements, assessment questions, mappings, or branded templates. A named human engagement owner confirms applicability and source rights.

**Guide-specific planning input.** Counsel records changes; operators refresh data, purpose, recipient, retention, sensitive-data, rights, appeals, notices, consent, opt-out, assessment, and processor evidence.
...
### 2. Operating evidence for Virginia Consumer Data Protection Act

- **Request and owner:** Time-bounded design/operating records, asset/configuration, maintenance, test/exercise, supplier, and corrective-action records, selected because this guide focuses on counsel records changes; operators refresh data, purpose, recipient, retention, sensitive-data, rights, appeals, notices, consent, opt-out, assessment, and processor evidence., from engineering, safety, operations, and supplier owners.
