# PCI DSS v4.0.1 SAQ D for Service Providers engagement guide
...
Treat the service-provider SAQ D workflow as a comprehensive assessment of the provider's actual services and responsibilities, not as a generic customer questionnaire. Maintain a controlled scope record for offered services, customer and subcontractor boundaries, account-data flows, hosted and managed components, administrative access, locations, service changes, incidents, contractual commitments, and customer-assurance evidence. Clearly distinguish provider-operated controls from customer responsibilities and from contract-specific representations. Escalate scope, profile, or responsibility ambiguity before an assessment or representation is prepared.
